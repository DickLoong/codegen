...
public class GzTarUtil {
	...
	public static void main(String[] args) {
		...
		GzTarUtil util = new GzTarUtil();
		util.execute(sourceFilePath, zipFilePath + File.separator + fileName );
	}
	/*
	...
	public void execute(String inputFileName, String targetFileName) {
		...
		if(os.toLowerCase().startsWith("win")){  
			base = inputFileName.substring(inputFileName.lastIndexOf("\\") + 1);
		}  
