...
public class TarenaPointawardCsvChecker implements CsvChecker {
	...
	public static void main(String[] args) {
		new TarenaPointawardCsvChecker().checkCsv("D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_configs\\csvfiles\\Public\\Common\\"
				+ "TArena(竞技场)_Pointaward(积分奖励表).csv");
	}
}
