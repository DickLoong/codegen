...
public class TbackpackGiftpackCsvChecker implements CsvChecker {
	...
	public Map<String, Object> getCache(int id) {
		checkCsv("D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_configs\\csvfiles\\Public\\Common\\TBackpack(背包系统)_Giftpack(奖励礼包配置).csv");
