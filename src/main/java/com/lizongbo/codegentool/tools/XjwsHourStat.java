...
public class XjwsHourStat {
	...
	public static void meixiaoshiTongji() {
		...
		sb.append("\n今日iOS登录泰奇用户数" + getTodayLoginUserCount(2).replaceAll("dau", "").trim() + ";");
		...
		String mailto[] = new String[] { "quickli@billionkj.com", 
				//"yaoheng@billionkj.com", 
				"wangherong@billionkj.com",
