...
public class InterfaceGeneratorV4 {
	public static final String metaCsvFilePath = "D:\\workspace\\server\\OperateConsole\\interface\\CodeGenConf"
			+ "\\InterfaceDetail\\DInterfaceMeta_Interfacemeta.csv";
	public static final String interfaceCsvFileOutputPath = "D:\\workspace\\server\\OperateConsole\\interface\\CodeGenConf";
	public static final String interfaceCsvFileGameServerHessianServiceOutputPath = "D:\\workspace\\server\\Game\\src\\main\\java\\com\\rxgame\\base";
	public static final String interfaceCsvFileGameServerRequestObjectOutputPath = "D:\\workspace\\server\\Game\\src\\main\\java\\com\\rxgame\\base";
	public static final String interfaceCodeOutPutpath = "D:\\workspace\\server\\OperateConsole\\"
			+ "src\\com\\rxgame\\base";

	public static final String mainControllerPath = "D:\\workspace\\server\\OperateConsole\\"
	...
	public static void interfaceMeta2Csv() throws Throwable {
		...
		if (rootCsvFile.isDirectory()) {
			for (int startRow = 2; startRow < metaData.size(); startRow++) {
				...
				codeBuilder.append("\n@Resource\n").append("private com.rxgame.base.logic.")
				...
				codeBuilder.append("	public ").append(returnType).append(" ").append(nameSpace).append(interfaceName)
						.append("(\n			" + requestBodyAnnotation + " com.rxgame.base.requestobject.")
						...
						.append("			").append(returnStr).append(" ").append("com.rxgame.base.logic.")
	...
	private static void interfaceCsv2GameServerProcessor(String nameSpace, String interfaceName, String creator,
		...
		StringBuilder codeBuilder = new StringBuilder();
		// 声明包
		codeBuilder.append("package com.rxgame.base.hessian.service").append(";").append("\n");
		codeBuilder.append("import com.rxgame.base.hessian.components.BaseHessianService;\n");
		codeBuilder.append("/*\n");
		...
		codeBuilder.append("              public ").append(returnType).append(" dealRemoteCommandRequest(")
				.append("com.rxgame.base.requestobject.").append(nameSpace).append(".")
	...
	public static void interfaceCsv2RequestObject(File interfaceCodeCSV, String nameSpace, String interfaceName,
		...
		StringBuilder codeBuilder = new StringBuilder();
		// 声明包
		codeBuilder.append("package com.rxgame.base.requestobject.").append(nameSpace)
				.append(";\n");
		codeBuilder.append("import com.rxgame.base.requestobject.BaseRequestObject;\n");
		codeBuilder.append("/*\n");
		codeBuilder.append("created by:").append(creator).append("\n");
		codeBuilder.append("create time:").append(createTime).append("\n");
		codeBuilder.append("comment:").append(comment).append("\n");
	...
	public static void interfaceCsv2Logic(File interfaceCodeCSV, String nameSpace, String interfaceName, String creator,
		...
		StringBuilder codeBuilder = new StringBuilder();
		// 声明包
		codeBuilder.append("package com.rxgame.base.logic.").append(nameSpace).append(";\n");
		codeBuilder.append("import org.springframework.stereotype.Controller;\n\n");
		codeBuilder.append("import org.springframework.web.servlet.ModelAndView;\n\n");
		codeBuilder.append("import com.alibaba.fastjson.JSON;\n")
				.append("import utils.WebUtil;\n")
				.append("import com.rxgame.game.util.LogWrapper;\n\n");
		String interfaceRequestObjectClassName = nameSpace + interfaceName + "RequestObject ";
		codeBuilder.append("import com.rxgame.base.requestobject.").append(nameSpace).append(".")
		...
		codeBuilder.append("//本接口默认本地访问路径是http://localhost:8080/").append(nameSpace).append("/").append(interfaceName)
				.append(".do\n");
		codeBuilder
				.append("//本接口页面本地访问路径是D:\\workspace\\server\\OperateConsole\\web\\WEB-INF\\page\\")
