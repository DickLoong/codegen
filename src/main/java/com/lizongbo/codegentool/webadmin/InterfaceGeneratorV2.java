...
public class InterfaceGeneratorV2 {
	public static final String metaCsvFilePath = "D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_operateconsole\\CodeGenConf"
			+ "\\InterfaceDetail\\DInterfaceMeta_Interfacemeta.csv";
	public static final String interfaceCsvFileOutputPath = "D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_operateconsole\\"
			+ "CodeGenConf\\InterfaceDetail";
	public static final String interfaceCsvFileGameServerHessianServiceOutputPath = "D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_server"
			+ "\\WEB-INF\\basesrc\\net\\bilinkeji\\gecaoshoulie";
	public static final String interfaceCsvFileGameServerRequestObjectOutputPath = "D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_server\\WEB-INF\\basesrc\\net\\bilinkeji\\gecaoshoulie";
	public static final String interfaceCodeOutPutpath = "D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_operateconsole\\"
			+ "src\\net\\bilinkeji\\gecaoshoulie\\";

	public static final String mainControllerPath = "D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_operateconsole\\"
	...
	public static void interfaceMeta2Csv() throws Throwable {
		...
		codeBuilder.append("import net.bilinkeji.gecaoshoulie.util.WebUtil;\n");
		...
		if (rootCsvFile.isDirectory()) {
			for (int startRow = 2; startRow < metaData.size(); startRow++) {
				...
				// package
				// net.bilinkeji.gecaoshoulie.mgameprotorpc.hessian.impl;
				File gameServerProcessorCodeDir = new File(interfaceCodeOutPutpath, "mgameprotorpc");
				if (!gameServerProcessorCodeDir.exists()) {
					gameServerProcessorCodeDir.mkdir();
				}
				gameServerProcessorCodeDir = new File(gameServerProcessorCodeDir, "hessian");
				if (!gameServerProcessorCodeDir.exists()) {
					gameServerProcessorCodeDir.mkdir();
				}
				...
				gameserverHessianServerCodeDir = new File(gameserverHessianServerCodeDir, "hessian");
				if (!gameserverHessianServerCodeDir.exists()) {
					gameserverHessianServerCodeDir.mkdir();
				}
				...
				codeBuilder.append("\n@Resource\n").append("private net.bilinkeji.gecaoshoulie.logic.")
				...
				codeBuilder.append("	public ").append(returnType).append(" ").append(nameSpace).append(interfaceName)
						.append("(\n			" + requestBodyAnnotation + " net.bilinkeji.gecaoshoulie.requestobject.")
						.append(nameSpace.toLowerCase()).append(".").append(interfaceRequestObjectClassName)
						...
						.append("			").append(returnStr).append(" ").append("net.bilinkeji.gecaoshoulie.logic.")
	...
	private static void interfaceCsv2GameServerProcessor(String nameSpace, String interfaceName, String creator,
		...
		StringBuilder codeBuilder = new StringBuilder();
		// 声明包
		codeBuilder.append("package net.bilinkeji.gecaoshoulie.mgameprotorpc.hessian.service").append(";").append("\n");
		codeBuilder.append("import net.bilinkeji.pbhessian.service.PbHessianService;\n");
		codeBuilder.append("/*\n");
		...
		codeBuilder.append("public interface I").append(nameSpace).append(interfaceName)
				.append("GameServerHessianService extends PbHessianService\n");
		// 声明方法
		codeBuilder.append("{\n");
		...
		codeBuilder.append("              public ").append(returnType).append(" dealRemoteCommandRequest(")
				.append("net.bilinkeji.gecaoshoulie.requestobject.").append(nameSpace.toLowerCase()).append(".")
	...
	public static void interfaceCsv2RequestObject(File interfaceCodeCSV, String nameSpace, String interfaceName,
		...
		codeBuilder.append("package net.bilinkeji.gecaoshoulie.requestobject.").append(nameSpace.toLowerCase())
				.append(";\n");
		codeBuilder.append("import net.bilinkeji.gecaoshoulie.requestobject.BaseRequestObject;\n");
		codeBuilder.append("/*\n");
		codeBuilder.append("created by:").append(creator).append("\n");
		codeBuilder.append("create time:").append(createTime).append("\n");
		codeBuilder.append("comment:").append(comment).append("\n");
	...
	public static void interfaceCsv2Logic(File interfaceCodeCSV, String nameSpace, String interfaceName, String creator,
		...
		codeBuilder.append("import com.alibaba.fastjson.JSON;\n")
				.append("import net.bilinkeji.gecaoshoulie.util.WebUtil;\n")
		...
		codeBuilder.append("//本接口默认本地访问路径是http://localhost:8080/").append(nameSpace).append("/").append(interfaceName)
				.append(".do\n");
		codeBuilder
				.append("//本接口页面本地访问路径是D:\\mgamedev\\workspace\\gecaoshoulie_proj\\gecaoshoulie_operateconsole\\WebContent\\WEB-INF\\page\\")
